...
Sections~\ref{sec:pain}--\ref{sec:arch} state the problem and the architecture.
Sections~\ref{sec:stack}--\ref{sec:sec} cover implementation and security.
Sections~\ref{sec:related}--\ref{sec:risk} address positioning, commercial model and
open risks.
...
filters. This is the party that will pay for a solution.
...
Incubation and Innovation Centre at IIT Kanpur and funded by Pine Labs, including a
ten-day industry immersion in Pune.
...
UPI path requires capital & --- & Float requires a PPI licence; direct redistribution requires a PA licence at \rs 15\,crore net worth. \\
