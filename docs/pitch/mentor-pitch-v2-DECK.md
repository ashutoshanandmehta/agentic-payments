# KNOW YOUR AGENT — DECK BUILD SHEET

**Purpose of this file:** slide-by-slide content ready to drop into your own template.
No visual design here on purpose — every slide gives you **on-slide text** (short enough to
project), a **visual instruction** for your designer/template, and **speaker notes** (what you
actually say, which is where the detail lives).

**The one rule:** on-slide text is a *headline plus signposts*, never paragraphs. If a bullet
runs past ~8 words, it belongs in the notes.

| | |
|---|---|
| Slides | 12 + 2 appendix |
| Target runtime | 9–11 min, plus Q&A |
| Deck title | Know Your Agent |
| Closing line | *Your bank knows you. Nobody knows your agents.* |
...
*Footer:* [Your name] · [Program] · 29 July 2026
